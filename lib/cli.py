...
class LiveArgs(FaceSwapArgs):
    """ A tool for live face swap with camera """

    @staticmethod
    def get_info():
        """ Return command information """
        return "A tool for live face swap with camera"
    ...
    def get_optional_arguments():
        ...
        argument_list.append({
            ...
            "default": "opencv",
            "help": "R|The plugin to use to output the converted images. The writers are "
                    "configurable in '/config/live.ini' or 'Settings > Configure Live "
                    "Plugins:'"
                    "\nL|ffmpeg: [video] Writes out the convert straight to video. When the input "
                    "is a series of images then the '-ref' (--reference-video) parameter must be "
                    "set."
